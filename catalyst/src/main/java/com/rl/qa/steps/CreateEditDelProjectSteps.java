...
public class CreateEditDelProjectSteps {
    ...
    public void iVerifyTheCreatedInProjectTable(String proName) throws Throwable {
        CreateEditDelProjectViews.verifyCreatedProject(proName);
    }

    @And("^I verify the \"([^\"]*)\" is deleted from project table$")
    ...
    @And("^I verify the \"([^\"]*)\" with assigned \"([^\"]*)\" in project table$")
