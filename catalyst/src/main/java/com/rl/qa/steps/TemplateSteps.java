...
public class TemplateSteps {
    ...
    @And("^I verify the \"([^\"]*)\" is deleted from the Templates table$")
    ...
    @And("^I select \"([^\"]*)\" and verify corresponding \"([^\"]*)\" in Templates table$")
    ...
    public void iSelectFromTheSelectBoxInCreateTemplatePage(String orgName) throws Throwable {
