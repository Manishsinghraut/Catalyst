...
//    }
    ...
    @And("^I enter new \"([^\"]*)\" in edit box$")
    public void iEnterNewInEditBox(String newBGrpName) throws Throwable {
    ...
    @And("^I verify the edited \"([^\"]*)\" in Business group table$")
    ...
    @And("^I verify the \"([^\"]*)\" is deleted from the Business Group table$")
    ...
    @And("^I verify \"([^\"]*)\" with assigned \"([^\"]*)\" in the Business group list$")
    public void iVerifyWithAssignedInTheBusinessGroupList(String bGroup, String org) throws Throwable {
