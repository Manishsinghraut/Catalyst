...
public class CreateEditDelDesignerSteps {
    ...
    @And("^I Verify the \"([^\"]*)\" User is created$")
    ...
    @And("^I Verify the \"([^\"]*)\" User with this \"([^\"]*)\" is created$")
    ...
    @And("^I Verify the \"([^\"]*)\" User with this \"([^\"]*)\" created$")
    ...
    @And("^I Verify the \"([^\"]*)\" User with this \"([^\"]*)\" is available$")
    ...
    @And("^I select the \"([^\"]*)\" and verify \"([^\"]*)\" Button is enabled$")
    ...
    @And("^I Verify the \"([^\"]*)\" user is deleted$")
