...
//            SeleniumUtil.waitForElementVisibilityOf("xpath","(//a[text()='Add'])[1]",5, SeleniumUtilities.OBJWAITTIMEOUT);
            SeleniumUtil.dblClick("xpath","(//a[text()='Add'])[1]", SeleniumUtil.OBJWAITTIMEOUT);
    ...
    public static String enterRandomEnvName(String idOfEditBox) {
        try {
            ...
            SeleniumUtil.click("cssselector", ".btn.btn-default.btn-primary.createchefenvbtn", SeleniumUtil.OBJWAITTIMEOUT);
