 ...
 */
public class ConfigureAWSProviderViews {
...
//            SeleniumUtil.click("xpath",".//*[@id='select2-drop']//*[text()='"+providerType+"']",SeleniumUtilities.OBJWAITTIMEOUT);
    ...
    public static void selectOrg(String orgName) {
        try {
            ...
            //Thread.sleep(1000);
            SeleniumUtil.click("xpath","//select/option[@value='"+orgName+"']", SeleniumUtilities.OBJWAITTIMEOUT);
        }
        catch(Exception ex){
...
//            SeleniumUtil.click("xpath","//*[text()='"+keyPair+"']",SeleniumUtilities.OBJWAITTIMEOUT);
    ...
    public static void browsePemFile() {
        try {
            ...
            driver.findElement(By.xpath("(//*[@type='file'])[5]")).sendKeys(path);
        }
        catch(Exception ex){
            BaseView.takeScreenshot("selectKeyPair");
            SeleniumUtil.Log.info("Error :" + ex.getMessage());
...
//            }
    ...
    public static void browseAzurePemFile(String pemFileName) {
        try {
            String path  = new String(new File(".").getCanonicalPath() + "/src/test/resources/Upload/"+pemFileName);
            WebDriver driver=SeleniumUtil.getWebDriver();
            driver.findElement(By.id("azurepem")).sendKeys(path);
        }
        catch(Exception ex){
            BaseView.takeScreenshot("selectKeyPair");
            SeleniumUtil.Log.info("Error :" + ex.getMessage());
    ...
    public static void browseAzurePrivateKeyFile(String privateKeyFile) {

        try {
            String path  = new String(new File(".").getCanonicalPath() + "/src/test/resources/Upload/"+privateKeyFile);
            WebDriver driver=SeleniumUtil.getWebDriver();
            driver.findElement(By.id("azurekey")).sendKeys(path);
        }
        catch(Exception ex){
            BaseView.takeScreenshot("selectKeyPair");
            SeleniumUtil.Log.info("Error :" + ex.getMessage());
    ...
    public static void browseOpenStackPemFile(String openStackpemFile) {
        ...
        try {
            ...
            WebDriver driver= SeleniumUtil.getWebDriver();
            driver.findElement(By.id("openstackinstancepem")).sendKeys(path);
        }
        catch(Exception ex){
