...
public class CreateEditDelJenkinsViews {
    ...
    public static void enterJenkinsName(String nameOfJenkins,String idOfEditBox){
        try {
            SeleniumUtil.waitForElementVisibilityOf("id",idOfEditBox,8,SeleniumUtilities.OBJWAITTIMEOUT);
            SeleniumUtil.type("id",idOfEditBox,nameOfJenkins,SeleniumUtilities.OBJWAITTIMEOUT);
            logger.info("Value entered "+nameOfJenkins);
        }
        catch(Exception ex){
