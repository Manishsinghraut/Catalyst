...
public class CreateEditDelOrgViews {
    ...
    public static void saveOrg() {
        try {
            SeleniumUtil.click("xpath", "//button[@class='btn btn-primary btn-mini']", SeleniumUtilities.OBJWAITTIMEOUT);
        } catch (Exception ex) {
...
//                logger.info("Edited Organization" + editedOrg + " does not exist");
    ...
    public static void verifyStatusOfOrg(String status,String orgName) {
        try {
            ...
            assertTrue(SeleniumUtil.verifyTextValue("xpath",".//*[@id='envtable']//td[text()='"+orgName+"']/../td[text()='"+status+"']","Active",5));
