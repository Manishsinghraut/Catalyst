...
Feature: As a super user create, edit, delete Project
  ...
  Scenario Outline: As a super user I create a Project
    ...
    And I select the "<Project name>" and verify "Delete" Button is enabled
    And I select the "<Project name>" and verify "Edit" Button is enabled
  ...
  Scenario Outline: As a super user I edit the created project
    ...
    And I select "<Organization>" from the select box
    And I click on save button
    And I verify the created "<New Project name>" in project table
    And I verify the "<New Project name>" with assigned "<Organization>" in project table
    And I verify the "<New Project name>" with assigned "<Business Group>" in project table
    And I verify the "<New Project name>" with assigned "<new Description>" in project table
    And I select the "<New Project name>" and verify "Delete" Button is enabled
    And I select the "<New Project name>" and verify "Edit" Button is enabled
  ...
  Scenario Outline:As a super user I delete the created project
    ...
    And I verify the "<New Project name>" is deleted from project table
