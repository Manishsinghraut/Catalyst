@All
Feature: As a super user I Create, Edit & Delete Cloud Formation Template
  ...
  Scenario Outline: As a super user I create Cloud Formation Template
    ...
    Examples:
      ...
      | RL_Cloud     | UAT_RL1      | CloudFormation |

  Scenario Outline: As a super user I edit the created Cloud Formation Template
    ...
    Examples:
      ...
      | RL_Cloud    |RL_CloudTemp    |UAT_RL2     | CloudFormation  |

  Scenario Outline: As a super user I Delete the Cloud Formation template
