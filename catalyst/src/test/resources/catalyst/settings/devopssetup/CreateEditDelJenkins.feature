...
Feature: As a super user Create, Edit, Delete Jenkins
  ...
  Scenario Outline: As a super user I create a Jenkins
    ...
    And I click on save button
    And I verify "<Jenkins Ref Name>" in the jenkins table
    And I verify "<Jenkins Ref Name>" with "<Jenkins URL>" in the jenkins table
    And I verify "<Jenkins Ref Name>" with "<Organization>" in the jenkins table
    And I verify "<Jenkins Ref Name>" with "<User name>" in the jenkins table
    And I select the "<Jenkins Ref Name>" and verify "Edit" Button is enabled
    And I select the "<Jenkins Ref Name>" and verify "Delete" Button is enabled
...
#    And I verify select organization is disabled
    ...
    And I verify "<Jenkins Ref Name>" with "<Organization>" in the jenkins table
    And I verify "<Jenkins Ref Name>" with "<User name>" in the jenkins table
    And I select the "<New Jenkins Ref Name>" and verify "Edit" Button is enabled
    And I select the "<New Jenkins Ref Name>" and verify "Delete" Button is enabled

    Examples:

      |Jenkins Ref Name|New Jenkins Ref Name|Organization|Jenkins URL                      |User name  |
      |Jenkins         | Jenkins_UAT1       | UAT_RL1    |http://jenkins.rlcatalyst_uat.com|uat_admin|
  ...
  Scenario Outline: As a super user I delete the  created Jenkins
    ...
    And I verify created "<New Jenkins Ref Name>" is deleted
