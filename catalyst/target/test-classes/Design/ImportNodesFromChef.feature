...
Feature: As a super user I import nodes from chef server
  ...
  Scenario Outline: As a super user I create environment, and I edit the project and assign the environment to project
  ...
  Scenario Outline: As a super user I create a Team
    ...
    Examples:
      ...
      |UatTeam1        |UAT  Automation Team|  UAT_RL1    |Catalyst |
  ...
  Scenario Outline: As a super user I create a AWS Provider
    ...
    Examples:
      ...
      |RL_AWS           |  AKIAIIK5APRNV54QAVQA |bz6Hl4wtjXi5Mg2EaZxLR1I/7y0bmYXEiYINDBSp |  RLBilling   |   UAT_RL1  |US West (N. California)| bootstrapncal|
...
#    And I verify created "name of environments" in workzone
    And I verify created "name of environments" in workzone and click on it
...
#    And I click on the "OK" button on confirmation popup window
    ...
    Examples:
      |Organization|Blueprint Name   |Business Grp|Project |Template     |Chef Server    |User Name|Password Type|
      |    PhoenixApp | RL_Blueprint | Cat_UAT    |Catalyst|UAT_Template |Cat_Chef_Server|ubuntu   |Pem File     |
