...
Feature: As a super user configure VMWare provider
  ...
  Scenario Outline: As a super user I create a VMWare Provider
    ...
    And I click on save button
    And I verify "<VMWare Provider Name>" in the provider table
    And I verify "<VMWare Provider Name>" with "<Organization>" in the provider table
    And I verify "<VMWare Provider Name>" with "<Provider Type>" in the provider table
...
#      |  RL_VMWare         |    RL_VMWare_Dev      | vmware       |   UAT_RL1    |
  ...
  Scenario Outline: As a super user I delete the created a AWS Provider
    ...
    And I verify created "<VMWare Provider Name>" is deleted
