@all
Feature: Calculated Expense Offset with no cap (Ref : Jira Ticket No : Automation-764)
#Email verification is pending
  Scenario Outline: Import the attached Calculated Expense Offset with no Cap Amount contract xml
    ...
    And I import following files:
      | CalculatedExpenseOffsetWithNoCap.xml |
  ...
  5. Navigate to Payment Info->Sales and ensure that sales data exist for 12 period for 2014
    ...
    Examples:
      ...
      | Contract | Payment Info     | Calculated Expense Offset with no cap |
  ...
  Scenario Outline: As a delete user I process payment aand verify them in transactions page
    ...
    And I click on offset amount link "$2,500.00"
