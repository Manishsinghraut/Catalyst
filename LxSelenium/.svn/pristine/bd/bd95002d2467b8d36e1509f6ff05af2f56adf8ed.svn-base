@all
Feature: Changing Approval Limits (Ref : Jira Ticket No : AUTOMATION-848)
...
#      | numberOfApproversFld | 2     |
    ...
    Then I import following file name:
      ...
      | ApprovePaymentContractAA-ChangeLimit.xml                  |
    ...
    Examples:
      | Login User   | Login full username  | Portfolio Name                        | Contact Name 1                 |
      | DeleteAccess | Delete Access Access | Portfolio Member Approve Level-Enable | Approve Level Enabled 1 Member |
  ...
  3. Change line item status and then verify in Contract->Payment Info->Recurring Expenses page
    ...
    And I verify a unique row in grid "ApproveExpenseScheduleDiv" having unique value "Expense" under column header "Expense Group"
      | name          | value      |
      | Amount        | $1,000.00  |
      | Contract Name | <Contract> |
    And I verify a unique row in grid "ApproveExpenseScheduleDiv" having unique value "Base Rent" under column header "Expense Group"
      | name          | value      |
      | Amount        | $1,000.00  |
      | Contract Name | <Contract> |
    ...
    Examples:
      | Login User              | Contract                             |
      | Approve Level Enabled 1 | ApprovePaymentContractAA-ChangeLimit |