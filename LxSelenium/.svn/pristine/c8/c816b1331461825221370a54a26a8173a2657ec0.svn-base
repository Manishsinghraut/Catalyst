@all
Feature: (Ref : Jira Ticket No : Automation-670) Fixed Offset-Semi Annually-Per Period Gross Up-Period PR Calculation

  Scenario Outline: I import file for Fixed Offset-Semi Annually-Per Period Gross Up-Period PR Calculation
    ...
    And I import following file name:
      | 3FixedOffsetSemiAnnuallyPerPeriodGrossUp.xml |
  ...
  Examples:
    ...
    | DeleteAccess | Delete Access Access | Contract | Payment Info     | 3.Fixed Offset-Semi Annually-Per Period Gross Up |
...
#      | Sales      | December, 2014  | $200,000   | $0            | $2,380,000.00 | $50,000.00 | $50,000             | 10.00% | $119,000         |            | $119,000.00 |
    ...
    And I verify a row from grid "thisDiv" having unique value "06/30/2014" under column header "Effective Date"
      | name             | value             |
      | Group            | Base Rent         |
      | Type             | Rent              |
      | Category         | Expense           |
