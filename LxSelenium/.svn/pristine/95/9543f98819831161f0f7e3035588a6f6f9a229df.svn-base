@all
Feature: (Ref : Jira Ticket No : Automation-869), Adding Predecessor Task and Notification
  ...
  Scenario Outline: I import file for apply schedule template
    ...
    And I import following file name:
      ...
      | ScheduleGroup(3).xml                   |
      | PredecessorFacility.xml                |
      | PredecessorFacilitySpreadsheetView.xml |
  ...
  Scenario Outline: As a delete user I can able to add Predecessor Task and Notification in Gantt View
    Given I Login to IWMS using "<Login User>" access credentials
    ...
    Examples:
      ...
      | ScheduleGroup | DeleteAccess | Delete Access Access | Predecessor Facility |

  Scenario Outline: As a delete user I can able to add Predecessor Task and Notification in spreadsheet View
    Given I Login to IWMS using "<Login User>" access credentials
    And I check previous user login "<Login full username>" and continue if user "<Login User>" same or logout and login if not
    And I Search for the "<Entity Name>" that was created
    And Click on the name of the "<Entity Name>" in the results pop-up
    ...
    Examples:
      | Template      | Login User   | Login full username  | Entity Name                           |
      | ScheduleGroup | DeleteAccess | Delete Access Access | Predecessor Facility Spreadsheet View |