@all
Feature: (Ref : Jira Ticket No : Automation-499) As a delete user I can able to preserve global pages for Parcel

  Scenario Outline: As a delete user I can able to preserve global pages for Parcel
    Given I Login to IWMS using "<Login User>" access credentials
    And I check previous user login "<Login full username>" and continue if user "<Login User>" same or logout and login if not
    And I navigate to entity type "Parcels" named "<Entity Name>" through search option
    ...
    Examples:
      ...
      | DeleteAccess | Delete Access Access | Parcel      | Parcel Copy | Lucernex-Parcel |
...
#    Then I check previous user login "<Login full username>" and continue if user "<Login User>" same or logout and login if not
    ...
    And I import following file name:
      | Preserve_Parcel_Global_Pages.xml |
  ...
  Scenario Outline: As a delete user I verify global pages of Parcel
    Given I Login to IWMS using "<Login User>" access credentials
    And I check previous user login "<Login full username>" and continue if user "<Login User>" same or logout and login if not
    And I navigate to entity type "Parcels" named "<Entity Name>" through search option
    ...
    Examples:
      ...
      | DeleteAccess | Delete Access Access | Parcel      | Lucernex-Parcel | Parcel Copy | Preserve Parcel Global Pages |