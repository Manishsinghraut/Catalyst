@all
Feature: (Ref : Jira Ticket No : Automation-671) Fixed Offset- Semi Annually-Cumulative PR Calculation

  Scenario Outline: I import file for Fixed Offset- Semi Annually-Cumulative PR Calculation
    ...
    And I import following file name:
      | 4FixedOffsetSemiAnnuallyCumulative.xml |
  ...
  Examples:
    ...
    | DeleteAccess | Delete Access Access | Contract | Payment Info     | 4.Fixed Offset- Semi Annually- Cumulative |
  ...
  Scenario Outline: As a delete user I verify Recurring expenses, vendor allocation, precent rent,offset and break point line items
    ...
    And I verify the following fields value on editable page
      ...
      | PercentageRent_CodeBillingFrequencyID   | Semi-Annually   |
    ...
    And I verify a row from grid "BOGridPercentageRentBreakpoint" having unique value "07/01/2014" under column header "Begin Date"
      | name                 | value       |
      | End Date             | 12/31/2014  |
      | Sales Group          | Sales       |
      | Breakpoint Amount #1 | $100,000.00 |
