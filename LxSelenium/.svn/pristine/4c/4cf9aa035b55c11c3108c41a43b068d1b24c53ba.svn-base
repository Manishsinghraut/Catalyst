@all
Feature: Multiple Successor Scenario 4 - Finish on Date in Future (Ref : Jira Ticket No : AUTOMATION-1331)
  ...
  Scenario Outline: I import the following files
    ...
    And I import following file name:
      | MSProject-11006_1331.xml       |
      | MultipleSuccessorScenarioTemplate_1331.xml |

  Examples:
    | Login User   | Login full username  |
    | DeleteAccess | Delete Access Access |

  Scenario Outline: As a delete user I applying a "Multiple Successor Scenario" Template to MSProject-11006 entity
...
#    And I switch to default frame
  ...
  Scenario Outline: As a delete user I verify the Testing A -Complete Successor A1 and Successor A2 when Predecessor A is not begun
    When I Search for the "<Entity Name>" that was created
    And Click on the name of the "<Entity Name>" in the results pop-up
    Then I see "<Entity Name>" name on the header
    Then I navigate to "Details"
  ...
  Scenario Outline: As a delete user I verify the Testing B -Complete Successor B1 and Successor B2 when Predecessor B is Completed
  ...
  Scenario Outline: As a delete user I verify the Testing C -Complete Successor C1 and Successor C2 when Predecessor C is Canceled
    When I Search for the "<Entity Name>" that was created
    And Click on the name of the "<Entity Name>" in the results pop-up
    Then I see "<Entity Name>" name on the header
    Then I navigate to "Details"
  ...
  Scenario Outline: As a delete user I verify the Testing D -Complete Successor D1 and Successor D2 when Predecessor D is In-Process
    When I Search for the "<Entity Name>" that was created
    And Click on the name of the "<Entity Name>" in the results pop-up
    Then I see "<Entity Name>" name on the header
    Then I navigate to "Details"
