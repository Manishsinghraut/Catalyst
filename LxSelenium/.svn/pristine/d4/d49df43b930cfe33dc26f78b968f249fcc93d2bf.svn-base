@all
Feature: (Ref : Jira Ticket No : Automation-499) As a delete user I can able to preserve global pages for project

  Scenario Outline: As a delete user I can able to preserve global pages for project
    Given I Login to IWMS using "<Login User>" access credentials
    And I check previous user login "<Login full username>" and continue if user "<Login User>" same or logout and login if not
    When I navigate to entity type "Opening Projects" named "Lucernex-Project" through search option
...
#      | <Page Name 2> |
    ...
    Examples:
      | Login User   | Login full username  | Entity Type | Page Name 1          | Page Name 2    | Page Name 3 | Page Name 4    | Page Name 5   |
      | DeleteAccess | Delete Access Access | Project     | Project Details Copy | Email Log Copy | Survey Copy | Ownership Copy | Purchase copy |
...
#      | Email Log List |
    ...
    Examples:
      ...
      | DeleteAccess | Delete Access Access | Lucernex-Project | Opening Projects | Project Details Copy | Email Log Copy | Survey Copy | Ownership Copy | Purchase copy |
