@all
Feature: Multiple Predecessor Template Scenario 2 - Finish on date in future (Ref : Jira Ticket No : AUTOMATION-1327)
  ...
  Scenario Outline: I import the following files
    ...
    And I import following file name:
      | AMultiplePredecessorTemplate_1327.xml      |
      | MultiplePredecessorScenarioEntity_1327.xml |
  ...
  Examples:
    | Entity Name                                     |
    | Multiple Predecessor Scenario, TX United States |

  Scenario Outline: As a delete user I verify the Test Scenario 1 - One Predecessor is Completed and one is Canceled - Cancel Successor In Future
    When I Search for the "<Entity Name>" that was created
    And Click on the name of the "<Entity Name>" in the results pop-up
    Then I see "<Entity Name>" name on the header
    Then I navigate to "Details"
    ...
    And I drag the vertical split bar to right
    And I drag the vertical split bar to right
    And I verify the task name "Multiple Group 1", status "In-process", % Done "50", F/A Start is "[CURRENT DATE]" pluse 0 days,F/A End is "[CURRENT DATE]" pluse 2 days, F/A Duration "3 days", BL Start "12/24/2020" and BL End "12/28/2020"
    And I verify the task name "Multiple Predecessor 1.1", status "Completed", % Done "100", F/A Start is "[CURRENT DATE]" pluse 0 days,F/A End is "[CURRENT DATE]" pluse 0 days, F/A Duration "1 day", BL Start "12/24/2020" and BL End "12/24/2020"
    And I verify the task name "Multiple Predecessor 1.2", status "Canceled", % Done "0", F/A Start is "[CURRENT DATE]" pluse 2 days,F/A End is "[CURRENT DATE]" pluse 2 days, F/A Duration "0 days", BL Start "12/28/2020" and BL End "12/28/2020"
    And I verify the task name "Multiple Successor 1", status "Not begun", % Done "0", F/A Start is "[CURRENT DATE]" pluse 2 days,F/A End is "[CURRENT DATE]" pluse 2 days, F/A Duration "1 day", BL Start "12/28/2020" and BL End "12/28/2020"
  ...
  Scenario Outline: As a delete user I verify the Test Scenario 2 - One Predecessor is Canceled and one is In-process - Complete Successor In Future
  ...
  Scenario Outline: As a delete user I verify the Test Scenario 3 - One Predecessor is Canceled and one is In-process - Complete Successor In Future
    When I Search for the "<Entity Name>" that was created
    And Click on the name of the "<Entity Name>" in the results pop-up
    Then I see "<Entity Name>" name on the header
    Then I navigate to "Details"
  ...
  Scenario Outline: As a delete user I verify the Test Scenario 4 - One Predecessor is Completed and one is Canceled - Complete Successor In Future
    When I Search for the "<Entity Name>" that was created
    And Click on the name of the "<Entity Name>" in the results pop-up
    Then I see "<Entity Name>" name on the header
    Then I navigate to "Details"
