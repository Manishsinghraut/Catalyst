@all
Feature: Fixed Offset-Quarterly-Annual Gross-Up Calculation (Ref : Jira Ticket No : Automation-674)

  Scenario Outline: I import file for Fixed Offset - Semi Annually-AnnualGrossUp Calculation
    ...
    And I import following file name:
      | 6FixedOffsetQuarterlyAnnualGrossup.xml |

  Examples:s
    | Login User   | Login full username  |
    | DeleteAccess | Delete Access Access |

  Scenario Outline: As a delete user I verify sales items of 6.Fixed Offset-Quarterly-Annual Gross-Up entity
    Given I Login to IWMS using "<Login User>" access credentials
    Then I check previous user login "<Login full username>" and continue if user "<Login User>" same or logout and login if not
  ...
  Examples:
    ...
    | DeleteAccess | Delete Access Access | Contract | Payment Info     | 6.Fixed Offset-Quarterly-Annual Gross-Up |


  Scenario Outline: As a delete user I verify Recurring expenses, vendor allocation, precent rent,offset and break point line items of 6.Fixed Offset-Quarterly-Annual Gross-Up entity
    Given I Login to IWMS using "<Login User>" access credentials
    Then I check previous user login "<Login full username>" and continue if user "<Login User>" same or logout and login if not
    When I navigate to entity type "<Item>" named "<Entity Name>"
    Then I navigate to "<Second Level Tab>"
    ...
    And I verify a row from grid "BOGridPercentageRentBreakpoint" having unique value "01/01/2000" under column header "Begin Date"
      ...
      | Natural Rate          |            |
      | Breakpoint Amount #1  | $25,000.00 |
      | Breakpoint Rate #1    | 10.00000%  |
      | Breakpoint Amount #2  | $50,000.00 |
  ...
  Scenario Outline: As a delete user I process payment of 6.Fixed Offset-Quarterly-Annual Gross-Up entity
    Given I Login to IWMS using "<Login User>" access credentials
    Then I check previous user login "<Login full username>" and continue if user "<Login User>" same or logout and login if not
    When I navigate to entity type "<Item>" named "<Entity Name>"
    Then I navigate to "<Second Level Tab>"
    ...
    And I verify line items in the single BP schedule grid "BOGridVirtualSalesPeriod"
      ...
      | Sales      | March, 2014     | $200,000   | $0            | $700,000      | $6,250     | $6,250              | 10.00% | $35,000.00       |            | $35,000.00  |
      | Sales      | April, 2014     | $200,000   | $0            |               |            |                     |        |                  |            |             |
      | Sales      | May, 2014       | $150,000   | $0            |               |            |                     |        |                  |            |             |
      | Sales      | June, 2014      | $200,000   | $0            | $1,250,000    | $12,500    | $12,500             | 10.00% | $62,500.00       |            | $62,500.00  |
      | Sales      | July, 2014      | $200,000   | $0            |               |            |                     |        |                  |            |             |
      | Sales      | August, 2014    | $200,000   | $0            |               |            |                     |        |                  |            |             |
      | Sales      | September, 2014 | $130,000   | $0            | $1,780,000    | $18,750    | $18,750             | 10.00% | $89,000.00       |            | $89,000.00  |
      | Sales      | October, 2014   | $200,000   | $0            |               |            |                     |        |                  |            |             |
      | Sales      | November, 2014  | $200,000   | $0            |               |            |                     |        |                  |            |             |
      | Sales      | December, 2014  | $200,000   | $0            | $2,380,000    | $25,000    | $25,000             | 10.00% | $119,000.00      |            | $119,000.00 |
      |            |                 | $2,380,000 | $0            |               |            |                     |        |                  | $0.00      |             |
#      | salesGroup | monthYear       | grossSales | excludedSales | leaseYTDSales | breakpoint | salesPastBreakpoint | rate   | totalPercentRent | amountPaid | percentOwed |
#      | Sales      | January, 2014   | $300,000   | $0            |               |            |                     |        |                  |            |             |
#      | Sales      | February, 2014  | $200,000   | $0            |               |            |                     |        |                  |            |             |
#      | Sales      | March, 2014     | $200,000   | $0            | $700,000.00   | $6,250.00  | $6,250              | 10.00% | $35,000          |            | $35,000.00  |
#      | Sales      | April, 2014     | $200,000   | $0            |               |            |                     |        |                  |            |             |
#      | Sales      | May, 2014       | $150,000   | $0            |               |            |                     |        |                  |            |             |
#      | Sales      | June, 2014      | $200,000   | $0            | $1,250,000.00 | $12,500.00 | $12,500             | 10.00% | $62,500          |            | $62,500.00  |
#      | Sales      | July, 2014      | $200,000   | $0            |               |            |                     |        |                  |            |             |
#      | Sales      | August, 2014    | $200,000   | $0            |               |            |                     |        |                  |            |             |
#      | Sales      | September, 2014 | $130,000   | $0            | $1,780,000.00 | $18,750.00 | $18,750             | 10.00% | $89,000          |            | $89,000.00  |
#      | Sales      | October, 2014   | $200,000   | $0            |               |            |                     |        |                  |            |             |
#      | Sales      | November, 2014  | $200,000   | $0            |               |            |                     |        |                  |            |             |
#      | Sales      | December, 2014  | $200,000   | $0            | $2,380,000.00 | $25,000.00 | $25,000             | 10.00% | $119,000         |            | $119,000.00 |
#      |            |                 | $2,380,000 | $0         |               |            |                     |        |                  | $0.00      |             |
    ...
    And I verify the "Percentage Rent (Single BP) Schedule" values at the bottom of the page
      ...
      | Offset Amount         | $2,400.00   |
      | Net Amount Due        | $116,600.00 |
    ...
    And I click on the "Process Payment" action panel button
#    when second time modal window opens without page refresh the below method looks for the previously closed modal window
#    And I see the "Process Payment" modal window
    And I set following list fields values on editable page
      | name         | value |
      | mnToGenerate | June  |
    ...
    And I verify a row from grid "thisDiv" having unique value "$34,400.00" under column header "Total Amount"
      | name             | value             |
      | Group            | Lease Expense     |
      ...
      | Total Amount     | $34,400.00        |
      | Primary Tax      | $0.00             |
      | Hold Flag        | No                |
    And I verify a row from grid "thisDiv" having unique value "$26,900.00" under column header "Total Amount"
      | name             | value             |
      | Group            | Lease Expense     |
      | Type             | Percentage Rent   |
      | Category         | Expense           |
      ...
      | Vendor#          | 1234              |
      | One-Time Expense | Yes               |
      | Total Amount     | $26,900.00        |
      | Primary Tax      | $0.00             |
      | Hold Flag        | No                |
    And I verify a row from grid "thisDiv" having unique value "$25,900.00" under column header "Total Amount"
      | name             | value             |
      | Group            | Lease Expense     |
      | Type             | Percentage Rent   |
      | Category         | Expense           |
      ...
      | Primary Tax      | $0.00             |
      | Hold Flag        | No                |
    And I verify a row from grid "thisDiv" having unique value "$29,400.00" under column header "Total Amount"
      | name             | value             |
      | Group            | Lease Expense     |
      | Type             | Percentage Rent   |
      | Category         | Expense           |
