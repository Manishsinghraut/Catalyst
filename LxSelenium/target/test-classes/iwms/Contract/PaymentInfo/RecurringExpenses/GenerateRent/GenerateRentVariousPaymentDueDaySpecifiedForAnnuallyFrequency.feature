@all
Feature: (JIRA - AUTOMATION-952)Generate Rent - Various Payment Due day specified for Annually Frequency

  Scenario Outline: As a delete user I Generate Rent - Various Payment Due day specified for Annually Frequency
    ...
    And I import following file name:
      | PaymentFrequenciesAnnually.xml |
...
#    And I navigate to second level "<Second Level Tab>" and third level "Recurring Expenses" tabs
    ...
    And I verify the following fields value on editable page
      | name                       | value      |
      | PaymentTransaction_DueDate | 01/28/2015 |
    ...
    Examples:
      ...
      | Single Contract | 2015 | January | DeleteAccess | Delete Access Access | Contract    | Payment Frequencies Annually | Payment Info     |
#      | Single Contract | 2015 | January | LxSelenium | Selenium Tester     | Contract    | Payment Frequencies Annually | Payment Info     |