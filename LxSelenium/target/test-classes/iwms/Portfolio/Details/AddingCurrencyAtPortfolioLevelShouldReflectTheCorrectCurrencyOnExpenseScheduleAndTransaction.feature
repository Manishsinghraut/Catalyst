@all
Feature: Adding Currency at Portfolio Level should reflect the correct currency on Expense schedule and Transaction (Jira Ref: AUTOMATION-1290)
  ...
  Scenario Outline: As a delete user I Navigate to  Admin Dashboard > Manage Company > Financial Settings > and select JPY as the 'Home Currency' and click 'Update'
    ...
    And I import following file name:
      | CurrencyEntities-15685_1290.xml |
  ...
  Scenario Outline: As a delete user I Navigate to "CurrencyPortfolio-15685" and verify the currency type
    Given I Login to IWMS using "<Login User>" access credentials
  ...
  Examples:
    ...
    | DeleteAccess | Delete Access Access | CurrencyPortfolio-15685 | Summary         |
  ...
  Examples:
    ...
    | DeleteAccess | Delete Access Access | CurrencyContract-15685 | Payment Info     | Recurring Expenses |