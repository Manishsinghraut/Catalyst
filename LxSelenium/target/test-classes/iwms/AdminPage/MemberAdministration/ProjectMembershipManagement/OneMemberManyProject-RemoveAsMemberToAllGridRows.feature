@all
Feature: (AUTOMATION-1297) One Member many Project-Remove as Member to all Grid rows
  ...
  Scenario Outline: Verify members exist in Members/Contacts tab
    ...
    Examples:
      ...
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 1  |
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 2  |
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 3  |
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 4  |
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 5  |
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 6  |
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 7  |
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 8  |
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 9  |
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 10 |
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 11 |
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 12 |
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 13 |
      | Member 3a Testing 15650 | Opening Projects | Project OMMP 14 |
      | Member 3a Testing 15650 | Sites            | Site OMMP -19   |
      | Member 3a Testing 15650 | Sites            | Site OMMP -20   |


  Scenario Outline: Remove Member from all grid rows
    ...
    And I click on the "Remove Member from all grid rows" action of header "Planned Membership" in non frame grid "<Grid ID>"
    And I verify following values in non frame grid "<Grid ID>"
      | Type            | Name            | Portfolio/Program | Parent Region                     | Sub Region | Market             | Project Type | Current Membership | Planned Membership      |
      ...
      | Site            | Site OMMP -20   | Lucernex-Selenium | Central(Central region - preOpen) |            | Legacy Market Area |              | Member             | None <Member> <Manager> |
    ...
    Examples:
      ...
      | Testing 15650, Member 3a | entitySelect | Member 3a Testing 15650 |
