@all
Feature: (Ref : Jira Ticket No : Automation-668) Fixed Offset- Semi Annually- Per Period PR Calculation

  Scenario Outline: I import file for Fixed Offset- Semi Annually- Per Period PR Calculation
    ...
    And I import following file name:
      | 2FixedOffsetSemiAnnuallyPerPeriod.xml |
  ...
  Examples:
    ...
    | DeleteAccess | Delete Access Access | Contract | Payment Info     | 2.Fixed Offset- Semi Annually- Per Period |
  ...
  Scenario Outline: As a delete user I process payment
    ...
    And I verify line items in the single BP schedule grid "BOGridVirtualSalesPeriod"
      ...
      | Sales      | December, 2014  | $200,000   | $0            | $1,130,000    | $25,000    | $25,000             | 10.00% | $119,000.00      |            | $56,500.00  |
#      | salesGroup | monthYear       | grossSales | excludedSales | leaseYTDSales | breakpoint | salesPastBreakpoint | rate   | totalPercentRent | amountPaid | percentOwed |
#      | Sales      | January, 2014   | $300,000   | $0            |               |            |                     |        |                  |            |             |
#      | Sales      | February, 2014  | $200,000   | $0            |               |            |                     |        |                  |            |             |
#      | Sales      | March, 2014     | $200,000   | $0            |               |            |                     |        |                  |            |             |
...
#      | Sales      | October, 2014   | $200,000   | $0            |               |            |                     |        |                  |            |             |
#      | Sales      | November, 2014  | $200,000   | $0            |               |            |                     |        |                  |            |             |
#      | Sales      | December, 2014  | $200,000   | $0            | $1,130,000.00 | $25,000.00 | $25,000             | 10.00% | $119,000         |            | $56,500.00  |
