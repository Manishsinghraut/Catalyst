@all
Feature: (Jira - Automation- 1292) Add Recurring Expense and Generate Transaction with Currency as specified on Location
  ...
  Scenario Outline:  As delete user I navigate locations summary page and verify the Currency type
    ...
    Examples:
      ...
      | Parcels     | 15687-Parcel A    | Currency Type |
      | Portfolios  | 15687-Portfolio A | Currency Type |
  ...
  Scenario Outline:  As delete user I navigate to parcel, portfolio and contract summary page and verify the Currency type
    ...
    Examples:
      ...
      | Locations   | 15687-Location A | Region / Area Groups | JPY           | Currency |
      | Contracts   | 15687 Contract A | Financials           | JPY           | Currency |

  Scenario:  As delete user I add vendor allocation and expense schedule
    When I navigate to entity type "Contracts" named "15687 Contract A" through search option
    ...
    And I verify the following fields value on editable page
      ...
      | ExpenseVendorAllocation_EndDate   | 12/31/2030 |
    ...
    And I verify the following values in frame grid "BOGridExpenseVendorAllocation"
      ...
      | Selenium-Employer | 1234    | 100.00000%      | 5601 Democracy Dr | Plano | TX    | 01/01/2000 | 12/31/2030 |       |
    ...
    And I set following fields value on editable page
      | name                          | value |
      | ExpenseSchedule_PaymentAmount | 2000  |
...
#    And I wait for "Save Changes?" modal window to open in frame page
    ...
    And I verify the following values in frame grid "BOGridExpenseSchedule"
      ...
      | 01/01/2000 | 12/31/2030 | Review          | ¥2,000         | ¥24,000       | ¥0   | ¥2,000        | ¥2,000       |       |
    ...
    And I verify the following fields value on editable page
      ...
      | ExpenseSchedule_PaymentAmount      | ¥2,000     |
      | ExpenseSchedule_AnnualAmount       | ¥24,000    |
      | ExpenseSchedule_PaymentRate        | ¥0         |
      | ExpenseSchedule_FirstPaymentAmount | ¥2,000     |
      | ExpenseSchedule_LastPaymentAmount  | ¥2,000     |
  ...
  Scenario:  As delete user I generate transaction and verify the currency type
    ...
    Then I verify the following values in frame grid "thisDiv"
      ...
      | 01/01/2016     | Rent  | Base Rent | Expense  | Selenium-Employer | 1234    | No               | ¥2,000       | ¥0          | No        |
    And I verify the following fields value on editable page
      | name                                  | value  |
      | PaymentTransaction_InvoiceAmount      | ¥2,000 |
      | PaymentTransaction_TaxAmount1         | ¥0     |
      | PaymentTransaction_TaxAmount2         | ¥0     |
      | PaymentTransaction_TaxAmount3         | ¥0     |
      | PaymentTransaction_TotalAmount        | ¥2,000 |
