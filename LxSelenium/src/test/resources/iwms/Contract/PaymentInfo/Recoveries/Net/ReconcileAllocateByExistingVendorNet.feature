Feature: Reconcile-Allocate by Existing Vendor (Jira Ref : AUTOMATION-739)
...
#    And I verify the following message "This recovery record was already reconciled."
  ...
  Examples:
    ...
    | Recoveries_Reconcile | Payment Info     | Recoveries      | Contract Expense Recovery (Net) List | thisDiv |
