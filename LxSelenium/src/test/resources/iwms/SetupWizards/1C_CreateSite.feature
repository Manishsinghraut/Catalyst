@all @smoke @smoke5
Feature: (Jira - Automation-340) As an admin I should be able to create Site Wizard
...
#      | Actual/Projected Delivery Date | 12/31/2015 |
    ...
    Examples:
      ...
      | Site | Site Setup Wizard | Lucernex-Selenium | New Site | Site Setup Wizard | Selenium Webdriver Prototype | Selenium Folder Template |
