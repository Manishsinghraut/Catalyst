@all
Feature: As an Delete user I need to be able to delete page layout.(Jira Ref. AUTOMATION-467)

  Scenario Outline: I import file for delete sub page layout
    ...
    And I import following file name:
      | Delete-Sub-Page-Layout.xml |

    Examples:
      | Login User   | Login full username  |
      | DeleteAccess | Delete Access Access |

  Scenario Outline: I want to delete sub page layout from manage page layout
    Given I Login to IWMS using "<Login User>" access credentials
    Then I check previous user login "<Login full username>" and continue if user "<Login User>" same or logout and login if not
    And I navigate to the admin dashboard
    And I click on the "Manage Page Layouts" link
    And I click on the "Manage Sub-pages"
...
#    Then I see "Successfully deleted item" in the grid header
    ...
    Examples:
      ...
      | Delete-Sub-Page-Layout | DeleteAccess | Delete Access Access |
      #Script is independent of other scripts