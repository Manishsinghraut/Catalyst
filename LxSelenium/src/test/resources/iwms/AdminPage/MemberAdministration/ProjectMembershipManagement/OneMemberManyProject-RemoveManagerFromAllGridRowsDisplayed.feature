@all
Feature: (AUTOMATION-1302) One Member many Project Remove Manager from all grid rows displayed
  ...
  Scenario Outline: Verify member exist in summary tab
    ...
    Examples:
      ...
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 1  |
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 2  |
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 3  |
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 4  |
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 5  |
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 6  |
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 7  |
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 8  |
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 9  |
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 10 |
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 11 |
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 12 |
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 13 |
      | Member 8a Testing 15650 | Opening Projects | Project OMMP 14 |
      | Member 8a Testing 15650 | Sites            | Site OMMP -19   |
      | Member 8a Testing 15650 | Sites            | Site OMMP -20   |
  ...
  Scenario Outline: Remove Manager from all grid rows displayed
    ...
    And I click on the "Remove Manager from grid rows displayed" action of header "Planned Membership" in non frame grid "<Grid ID>"
    And I verify following values in non frame grid "<Grid ID>"
      | Type            | Name            | Portfolio/Program | Parent Region                     | Sub Region | Market             | Project Type | Current Membership | Planned Membership      |
    ...
    Examples:
      ...
      | Testing 15650, Member 8a | entitySelect | Member 8a Testing 15650 |
