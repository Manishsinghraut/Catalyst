...
public class ChefServerSetupSteps {
    ...
    public void iSelectTheAndClickOnCorrespondingButton(String cherServerName ,String title) throws Throwable {
        ChefServerSetupViews.clickOnDelete(cherServerName,title);
    }
...
//                logger.info("Verified : " +Nodes);
    ...
    @Then("^I verify desired \"([^\"]*)\" is deleted$")
    public void iVerifyCreatedChefServerIsDeleted(String userName) throws Throwable {
        ChefServerSetupViews.verifyUserIsDeleted(userName);
    }
