...
//            element.sendKeys(path);
    ...
    public static void clickOnDelete(String designerUserName,String title ) {
        try{
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='envtable']//*[@datafield='orgname'][text()='"+orgName+"']/following-sibling::td//*[@title='Delete']")));
            SeleniumUtil.click("xpath","//*[@id='envtable']//*[@datafield='orgname'][text()='"+orgName+"']/following-sibling::td//*[@title='Delete']",SeleniumUtilities.OBJWAITTIMEOUT);
        }
        catch(Exception ex){
...
//                logger.info("Element is enabled");
    ...
    public static void verifyUserIsDeleted(String chefServerName) {
        try {
            ClassLoader classLoader = Thread.currentThread().getContextClassLoader();
            InputStream stream = classLoader.getResourceAsStream("lx-selenium.properties");
            Properties properties = new Properties();
            properties.load(stream);
            String userName=properties.getProperty("iwms.designerusername", "not_filtered");
            assertFalse(SeleniumUtil.verifyTextValue("xpath", "//*[@datafield='loginname' and Text()='"+userName+"']",userName,SeleniumUtilities.OBJWAITTIMEOUT)); {
